...
(and re-converted the same day as the Figma grew, now 59 slides) from the Figma Slides file "Inequality presentation in Prague": each slide is one html block whose
